...
var ELECTRICAL_UPDATE	= 0;									# Update interval in seconds. Set to 0 for once/frame
...
var electrical_update = func {
  ...
  if((getprop("/controls/gear/gear-down") != getprop("/controls/gear/gear-down-actual")) and 
     (getprop("/systems/electrical/outputs/gear") != 0)) {
      if(!getprop("/gear/gear[8]/wow"))
	  setprop("/controls/gear/gear-down-actual",getprop("/controls/gear/gear-down"));
  }
